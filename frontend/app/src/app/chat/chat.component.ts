...
export class ChatComponent implements OnInit {
  ...
  loadChatByEmail(event: string, event1: string) {
    ...
    this.chatService.getChatByFirstUserNameAndSecondUserName(event, event1).subscribe((data:any) => {
      // console.log(data);
      this.chatData = data;
  ...
  sendMessage() {
    ...
    this.chatService.updateChat(this.messageObj, this.chatId).subscribe((data:any) => {
      console.log(data);
      this.chatForm.reset();
